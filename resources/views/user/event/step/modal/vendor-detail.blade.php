            ...
            <div class="row product-container">
              ...
              @for ($i=0; $i < 8; $i++) <div class="col-lg-3 product-cart">
                    ...
                    <div>
                      <div id="owl-demo2" class="owl-carousel owl-carousel-icons2">
                        <div class="item">
                          <div class="card custom-card overflow-hidden mb-0 ">
                            <a href="{{url('filemanager-details')}}"><img
                                src="{{asset('build/assets/images/photos/44.jpg')}}" class="w-100" alt="img"></a>
                          </div>
                        </div>
                        <div class="item">
                          <div class="card custom-card overflow-hidden mb-0 ">
                            <a href="{{url('filemanager-details')}}"><img
                                src="{{asset('build/assets/images/photos/41.jpg')}}" class="w-100" alt="img"></a>
                          </div>
                        </div>
                        <div class="item">
                          <div class="card border-0 custom-card overflow-hidden mb-0 ">
                            <a href="{{url('filemanager-details')}}"><img
                                src="{{asset('build/assets/images/photos/42.jpg')}}" class="w-100" alt="img"></a>
                          </div>
                        </div>
                        <div class="item">
                          <div class="card custom-card overflow-hidden mb-0 ">
                            <a href="{{url('filemanager-details')}}"><img
                                src="{{asset('build/assets/images/photos/43.jpg')}}" class="w-100" alt="img"></a>
                          </div>
                        </div>
                        <div class="item">
                          <div class="card custom-card overflow-hidden mb-0 ">
                        ...
                        <div class="item">
                          <div class="card border-0 custom-card overflow-hidden mb-0 ">
                            <a href="{{url('filemanager-details')}}"><img
                                src="{{asset('build/assets/images/photos/45.jpg')}}" class="w-100" alt="img"></a>
                          </div>
                        </div>
                        <div class="item">
                          <div class="card custom-card overflow-hidden mb-0 ">
                ...
                <div class="d-flex" style="gap:.5rem;">
                  <button class="btn btn-gray button-detail-product" style="width: 100%;">Detail</button>
