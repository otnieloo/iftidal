<div>
          ...
          <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
            @foreach ($categories as $category)
              <li style="max-width: 110%;" class="nav-item text-center">
                <a class="nav-link {{ $loop->index == 0 ? 'active' : '' }} w-100" id="home-tab4" data-bs-toggle="tab" href="#tab{{ $category->id }}" role="tab"
                  aria-controls="home" aria-selected="true">{{ $category->vendor_category }}</a>
              </li>
            @endforeach
          </ul>
        </div>
        <div class="col-lg-10 col-md-12">
          <div class="tab-content border p-3" id="myTab3Content">
            ...
            @foreach ($categories as $category)
              ...
              <div class="tab-pane fade p-0 {{ $loop->index == 0 ? 'show active' : '' }}" id="tab{{ $category->id }}" role="tabpanel" aria-labelledby="home-tab4">
  ...
  <div class="modal fade" id="modalDetailVendor" tabindex="-1" aria-labelledby="modalDetailVendorLabel" aria-hidden="true" style="display: none;">
  ...
  <div class="modal fade" id="modalDetailProduct" tabindex="-1" aria-labelledby="modalDetailProductLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-fullscreen">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary btn-action-modal-product-close" onclick="Order.closeModalProduct()">Close</button>
        </div>
      </div>
    </div>
  </div>
