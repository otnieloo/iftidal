          ...
          <div class="row">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-lg-2 col-md-12">
                    <label class="form-label" for="event_name">{{ __('Name Event') }}<span class="field-req"> *</span></label>
                  </div>
                  <div class="col-lg-10 col-md-12">
                    <input type="text" name="event_name" id="event_name" wire:model.debounce.500ms="event_name" class="form-control">
                    {{-- @error('event_name')
                      {{ $message }}
                    @enderror --}}
                  </div>
            ...
            <div class="col-12">
              <div class="form-group">
                <div class="row">
                  <div class="col-lg-2 col-md-12">
                    <label class="form-label" for="event_date">{{ __('Date of Event') }}<span class="field-req"> *</span></label>
                  </div>
                  <div class="col-lg-8 col-md-12">
            ...
            <div class="col-12">
              <div class="form-group">
                <div class="row">
                  <div class="col-lg-2 col-md-12">
                    <label class="form-label" for="event_type_id">{{ __('Event Period') }}<span class="field-req"> *</span></label>
                  </div>
            ...
            <div class="col-12">
              <div class="form-group">
                <div class="row">
                  <div class="col-lg-2 col-md-12">
                    <label class="form-label" for="event_location">{{ __('Set Location') }}<span class="field-req"> *</span></label>
                  </div>
                  <div class="col-lg-8 col-md-12">
                    ...
                    {{-- <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="event_location" name="event_location" placeholder="Pick Location Address">
                    </div> --}}
                  </div>
                </div>
              </div>
            ...
            <div class="col-12">
              <div class="form-group">
                <div class="row">
                  <div class="col-lg-2 col-md-12">
                    <label class="form-label" for="event_number_guest">{{ __('Est. Number of Guest') }}<span class="field-req"> *</span></label>
                  </div>
                  <div class="col-lg-8 col-md-12">
            ...
            <div class="d-flex justify-content-center">
              <button type="button" class="btn btn-warning" wire:click="save" {{ $errors->any() ? 'disabled' : '' }}>Next</button>
            </div>
