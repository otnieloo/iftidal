          ...
          <div class="row gap-3">
            ...
            <div class="col-12">
              <div class="row">
                ...
                <div class="col-lg-8 col-md-12">{{ date('H:i', strtotime("$order->event_date $order->event_start_time"))
                  }} - {{ date('H:i', strtotime("$order->event_date $order->event_end_time")) }}</div>
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="row">
                ...
                <div class="col-lg-8 col-md-12">RM {{ $order->event_start_budget }} - RM {{ $order->event_end_budget }}
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="row mb-5">
                ...
                <div class="col-lg-8 col-md-12 event-summary" style="overflow: scroll;">
                  @foreach ($category->subs as $sub)
                  <div class="badges">{{ $sub->vendor_category }}</div>
                  @endforeach
                </div>
              </div>
              @endforeach
