                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <i
                                class="fe fe-calendar ms-auto fs-5 my-auto bg-primary-transparent p-3 br-7 text-primary"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <i
                                class="fe fe-calendar ms-auto fs-5 my-auto bg-secondary-transparent p-3 br-7 text-secondary"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <i
                                class="fe fe-users ms-auto fs-5 my-auto bg-warning-transparent p-3 br-7 text-warning"></i>
                        </div>
                    </div>
                </div>
            </div>
