      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="card overflow-hidden">
          <div class="card-body">
            <div class="d-flex">
              <div>
                <div class="mb-0 fw-semibold text-dark">Wallet Balance</div>
                <h3 class="mt-1 mb-1 text-dark fw-semibold">RM {{ $balance->wallet }}</h3>
                <div class="text-muted fs-12 mt-2">
                  <span class="fw-bold fs-12">2</span> Vendor Paid
                </div>
              </div>
              <i class="fa-solid fa-wallet ms-auto fs-5 my-auto bg-primary-transparent p-3 br-7 text-primary"></i>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="card overflow-hidden">
          <div class="card-body">
            <div class="d-flex">
              <div>
                <div class="mb-0 fw-semibold text-dark">My Event (s)</div>
                <h3 class="mt-1 mb-1 text-dark fw-semibold">{{ count($events) }}</h3>
                <div class="text-muted fs-12 mt-2">
                  <span class="fw-bold fs-12">{{ $events->where("event_date", ">", date("Y-m-d"))->count() }}</span> Upcoming Event
                </div>
              </div>
              <i class="fa-solid fa-calendar-check ms-auto fs-5 my-auto bg-secondary-transparent p-3 br-7 text-secondary"></i>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="card overflow-hidden">
          <div class="card-body">
            <div class="d-flex">
              <div>
                <div class="mb-0 fw-semibold text-dark">Total Vendor (s)</div>
                <h3 class="mt-1 mb-1 text-dark fw-semibold">{{ count($vendors) }}</h3>
                <div class="text-muted fs-12 mt-2">
                  <span class="fw-bold fs-12">{{ $vendors->where("created_at", ">=", date("Y-m-d H:i:s", strtotime("-7day")))->count() }}</span> News Vendors
                </div>
              </div>
              <i class="fa-solid fa-shop ms-auto fs-5 my-auto bg-info-transparent p-3 br-7 text-secondary"></i>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="card overflow-hidden">
          <div class="card-body">
            <div class="d-flex">
              <div>
                <div class="mb-0 fw-semibold text-dark">Total Invited Guest (s)</div>
                <h3 class="mt-1 mb-1 text-dark fw-semibold">{{ $guests->count() }}</h3>
                <div class="text-muted fs-12 mt-2">
                  <span class="fw-bold fs-12">{{ $guests->where("created_at", ">=", date("Y-m-d H:i:s", strtotime("-7day")))->count() }}</span> New Invited Guests
                </div>
              </div>
