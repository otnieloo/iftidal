    ...
    <div class="row">
      ...
      <div class="col-lg-9 col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-12">
              <div class="d-flex align-items-center justify-content-end">
                ...
                <input type="number" id="inputQtyDetail{{ $product->id }}" data-id="{{ $product->id }}" data-max="{{ $product->product_stock }}" max="{{ $product->product_stock }}" class="form-control qty-input">
                <div class="qty-button">+</div>
              </div>
        ...
        <div class="d-flex" style="gap:.5rem;">
          ...
          <button class="btn btn-info" onclick="Order.addToCart('{{ $product->id }}', true)">Add to cart</button>
        </div>
      </div>
