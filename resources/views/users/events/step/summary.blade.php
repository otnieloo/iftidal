<div class="row">
  <div class="col-lg-8 col-md-12">
        ...
        <div class="row gap-3">
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-12" id="textEventName"> </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-12" id="textEventType"> </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-12" id="textEventDate"> </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-12" id="textEventPeriod"> </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-12" id="textSetLocation"> </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-12" id="textEstGuest"> </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-12" id="textRangeBudget"></div>
            </div>
          </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12" id="rowOrderCategories">
          </div>
        </div>
      </div>
    ...
    <div class="d-flex justify-content-center">
      ...
      <button type="button" class="btn btn-warning" onclick="Order.nextStep3()">Next</button>
    </div>
