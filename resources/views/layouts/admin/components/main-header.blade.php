							...
							<div class="dropdown d-flex shopping-cart">
								...
								<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
									...
									<div class="header-dropdown-list message-menu">
										<div class="dropdown-item d-flex">
											...
											<div class="wd-50p d-flex flex-column">
												<a href="{{url('cart')}}"
													class="p-0 h6 text-dark fw-semibold mb-0">Flower pot home
													decores</a>
												<span>Qty: 1</span>
										...
										<div class="dropdown-item d-flex">
											...
											<div class="wd-50p d-flex flex-column">
												<a href="{{url('cart')}}"
													class="p-0 h6 text-dark fw-semibold mb-0">Smart watch</a>
												<span>Qty: 3</span>
										...
										<div class="dropdown-item d-flex">
											...
											<div class="wd-50p d-flex flex-column">
												<a href="{{url('cart')}}"
													class="p-0 h6 text-dark fw-semibold mb-0">Furniture (chair)</a>
												<span>Qty: 1</span>
												<span>Status: <span class="text-success">In
														Stock</span></span>
											</div>
										...
										<div class="dropdown-item d-flex border-bottom-0">
											...
											<div class="wd-50p d-flex flex-column">
												<a href="{{url('cart')}}"
													class="p-0 h6 text-dark fw-semibold mb-0">Running Shoes</a>
												<span>Qty: 4</span>
									...
									<div class="dropdown-footer d-felx justify-content-between align-items-center">
										<a class="btn btn-primary btn-pill btn-sm" href="{{url('checkout')}}"><i
